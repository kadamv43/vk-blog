            ...
            <section class="col-md-9">
                <article class="w-100">
                    ...
                    <div class="mb-4 text-center">
                        <img src="{{ asset($detail->image) }}" class="blog-image rounded shadow" alt="{{ $detail->title }}"
                            loading="lazy">
                    </div>
                            ...
                            @foreach ($relatedPosts as $post)
                                <div class="{{ $colClass }}">
                                    <div class="card shadow-sm related-card">
                                        ...
                                        <img src="{{ asset($post->image) }}" class="card-img-top related-img"
                                        ...
                                        <div class="card-body related-card-body">
                                            ...
                                            <a href="{{ route('details', $post->slug) }}"
                                                class="btn btn-primary btn-sm related-read-more">
                                                Read More
                                            </a>
