          ...
          <div class="col-md-9 pr-md-5">
            <div class="row">
              ...
              <div class="col-12">
                <div class="post-entry horizontal d-md-flex">
                  <div class="media">
                    <a href="#"><img src="{{asset('assets/frontend/images/img_h_5.jpg')}}" alt="Image" class="img-fluid"></a>
                  </div>
                  <div class="text">
              ...
              <div class="col-12">
                <div class="post-entry horizontal d-md-flex">
                  <div class="media">
                    <a href="#"><img src="{{asset('assets/frontend/images/img_h_6.jpg')}}" alt="Image" class="img-fluid"></a>
                  </div>
                  <div class="text">
                    <div class="meta-cat"><a href="#">Business</a></div>
                    <h2><a href="#">Far far away behind the Word Mountains far from Away</a></h2>
              ...
              <div class="col-12">
                <div class="post-entry horizontal d-md-flex">
                  <div class="media">
                    <a href="#"><img src="{{asset('assets/frontend/images/img_h_7.jpg')}}" alt="Image" class="img-fluid"></a>
                  </div>
                  <div class="text">
                    <div class="meta-cat"><a href="#">Business</a></div>
                    <h2><a href="#">Far far away behind the Word Mountains far from Away</a></h2>
              ...
              <div class="col-12">
                <div class="post-entry horizontal d-flex mb-0">
                  <div class="media">
                    <a href="#"><img src="{{asset('assets/frontend/images/img_h_8.jpg')}}" alt="Image" class="img-fluid"></a>
                  </div>
                  <div class="text">
                    <div class="meta-cat"><a href="#">Business</a></div>
                    <h2><a href="#">Far far away behind the Word Mountains far from Away</a></h2>
