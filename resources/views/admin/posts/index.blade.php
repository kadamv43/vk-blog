                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    {{-- <td>{{$datum->id}}</td> --}}
                                    <td><a href="{{route('posts.edit',$datum->id)}}">{{$datum->title}}</a></td>
                                    ...
                                    <td>
                                        ...
                                        <a class="mx-2" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#deleteModal" data-url="{{route('posts.destroy',$datum->id)}}">
